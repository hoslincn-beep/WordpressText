  ...
  class CSF {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        ...
        wp_enqueue_style( 'csf-fa5', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/css/all'. $min .'.css', array(), '5.14.0', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/css/v4-shims'. $min .'.css', array(), '5.14.0', 'all' );
      }
